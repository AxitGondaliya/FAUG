...
public class Pubg_All_Bage_Pack_Infomation_game extends Pubg_All_Base_WASticker_Games {
    private static final String TAG = "Pubg_All_Bage_Pack_Infomation_game";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pubg_all_bage_pack_informati_game);
        final String trayIconUriString = getIntent().getStringExtra(Pubg_ALL_Pack_Info_Details_Game.EXTRA_STICKER_PACK_TRAY_ICON);
        final String website = getIntent().getStringExtra(Pubg_ALL_Pack_Info_Details_Game.EXTRA_STICKER_PACK_WEBSITE);
        final String email = getIntent().getStringExtra(Pubg_ALL_Pack_Info_Details_Game.EXTRA_STICKER_PACK_EMAIL);
        final String privacyPolicy = getIntent().getStringExtra(Pubg_ALL_Pack_Info_Details_Game.EXTRA_STICKER_PACK_PRIVACY_POLICY);
        ...
        try {
            ...
            final Drawable emailDrawable = getDrawableForAllAPIs(R.drawable.pubg_game_email_icon);
