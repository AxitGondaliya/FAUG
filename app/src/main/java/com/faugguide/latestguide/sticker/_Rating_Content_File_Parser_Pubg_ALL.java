...
class _Rating_Content_File_Parser_Pubg_ALL {
    private static final int LIMIT_EMOJI_COUNT = 2;

    @NonNull
    static List<Pubg_ALL_Pack_Of_Sicker_Game> parseStickerPacks(@NonNull InputStream contentsInputStream) throws IOException, IllegalStateException {
    ...
    @NonNull
    private static List<Pubg_ALL_Pack_Of_Sicker_Game> readStickerPacks(@NonNull JsonReader reader) throws IOException, IllegalStateException {
        List<Pubg_ALL_Pack_Of_Sicker_Game> stickerPackList = new ArrayList<>();
        ...
        while (reader.hasNext()) {
            ...
            if ("android_play_store_link".equals(key)) {
                ...
                reader.beginArray();
                while (reader.hasNext()) {
                    Pubg_ALL_Pack_Of_Sicker_Game stickerPack = readStickerPack(reader);
    ...
    @NonNull
    private static Pubg_ALL_Pack_Of_Sicker_Game readStickerPack(@NonNull JsonReader reader) throws IOException, IllegalStateException {
        reader.beginObject();
        ...
        List<Games_Sticker_Parcelable_Pubg_ALL> stickerList = null;
        while (reader.hasNext()) {
            String key = reader.nextName();
            switch (key) {
                case "identifier":
        ...
        reader.endObject();
        final Pubg_ALL_Pack_Of_Sicker_Game stickerPack = new Pubg_ALL_Pack_Of_Sicker_Game(identifier, name, publisher, trayImageFile, publisherEmail, publisherWebsite, privacyPolicyWebsite, licenseAgreementWebsite);
        stickerPack.setStickers(stickerList);
        return stickerPack;
    }

    @NonNull
    private static List<Games_Sticker_Parcelable_Pubg_ALL> readStickers(@NonNull JsonReader reader) throws IOException, IllegalStateException {
        reader.beginArray();
        List<Games_Sticker_Parcelable_Pubg_ALL> stickerList = new ArrayList<>();
        ...
        while (reader.hasNext()) {
            ...
            stickerList.add(new Games_Sticker_Parcelable_Pubg_ALL(imageFile, emojis));
        }
        reader.endArray();
        return stickerList;
    }
