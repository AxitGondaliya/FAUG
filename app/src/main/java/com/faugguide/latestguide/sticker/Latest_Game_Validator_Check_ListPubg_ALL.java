...
public class Latest_Game_Validator_Check_ListPubg_ALL {
    ...
    public static void verifyStickerPackValidity(@NonNull Context context, @NonNull Pubg_ALL_Pack_Of_Sicker_Game stickerPack) throws IllegalStateException {
        ...
        try {
            final byte[] bytes = Pubg_ALL_Loader_Packages_Games.fetchStickerAsset(stickerPack.identifier, stickerPack.trayImageFile, context.getContentResolver());
        ...
        final List<Games_Sticker_Parcelable_Pubg_ALL> stickers = stickerPack.getStickers();
        ...
        for (final Games_Sticker_Parcelable_Pubg_ALL sticker : stickers) {
            validateSticker(context, stickerPack.identifier, sticker);
        }
    }

    private static void validateSticker(@NonNull Context context, @NonNull final String identifier, @NonNull final Games_Sticker_Parcelable_Pubg_ALL sticker) throws IllegalStateException {
    ...
    private static void validateStickerFile(@NonNull Context context, @NonNull String identifier, @NonNull final String fileName) throws IllegalStateException {
        try {
            final byte[] bytes = Pubg_ALL_Loader_Packages_Games.fetchStickerAsset(identifier, fileName, context.getContentResolver());
    ...
    private static boolean isValidWebsiteUrl(String websiteUrl) throws IllegalStateException {
        try {
            ...
            Log.e("Latest_Game_Validator_Check_ListPubg_ALL", "url: " + websiteUrl + " is malformed");
    ...
    private static boolean isURLInCorrectDomain(String urlString, String domain) throws IllegalStateException {
        try {
            ...
            Log.e("Latest_Game_Validator_Check_ListPubg_ALL", "url: " + urlString + " is malformed");
